...
namespace Cortez_Enzo_Evaluacion_P_I.Controllers
{
    public class CelularsController : Controller
    {
        ...
        public CelularsController(Cortez_Enzo_Evaluacion_P_IContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Modelo,Precio,Año")] Celular celular)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modelo,Precio,Año")] Celular celular)
        {
            if (id != celular.Id)
            {
                return NotFound();
